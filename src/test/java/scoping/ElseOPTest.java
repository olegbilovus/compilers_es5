...
public class ElseOPTest {
  ...
  public void valid() throws Exception {
    ScopeTable scopeTable =
        init(
            "func f() -> real: if true then else return 4; endif; return 3; endfunc proc main(): endproc");
    ...
    scopeTable = init(
        "func f() -> real: if true then else var a ^= true;\\ endif; return 1; endfunc proc main(): endproc");
